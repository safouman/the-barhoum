...
export function Footer({ ui }: FooterProps) {
  ...
  // Language-specific brand and tagline
  const brandName = locale === "ar" ? "ابراهيم بن عبد الله" : "Ibrahim ben Abdallah";
  const tagline = locale === "ar" ? "من أجل عالم أفضل" : "For a Better World";
  ...
  const socialLinks = [
    { 
      href: "https://instagram.com/barhoum", 
      label: "Instagram",
      icon: (
    ...
    { 
      href: "https://linkedin.com/in/barhoum", 
      label: "LinkedIn",
      icon: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
    ...
    { 
      href: "https://youtube.com/@barhoum", 
      label: "YouTube",
      icon: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
    ...
    { 
      href: "https://newsletter.barhoum.coach", 
      label: "Newsletter",
      icon: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
