...
const COPY: Record<"en" | "ar", Copy> = {
    ...
    ar: {
        ...
        body: "نستخدم ملفات تعريف الارتباط التحليلية لفهم كيفية استخدام موقع برهوم كوتشنغ. بالقبول تساعدنا على التطوير، أو يمكنك الرفض والاستمرار مع الملفات الأساسية فقط.",
